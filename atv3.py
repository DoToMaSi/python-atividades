# Declaro a função escolha_servico
def escolha_servico() -> float:
    # Inicio o loop
    while True:
        # Monto as opções desejadas
        ...
        try:
            ...
            # Se, por ventura, o usuário digitar um valor fora do padrão
...
# Declaro a função servico_extra
def servico_extra() -> int:
    while True:
        # Monto as opções na tela para o usuário
...
def main():
    # Boas Vindas
    print('Bem vindo a Copiadora do Douglas Tomacheski')
    print('\n')

    # Retorno o valor da função escolha_servico - retorna o valor do serviço selecionado.
    servico = escolha_servico()
    print('\n')
    # Retorno o valor da função num_pagina - retorna o número de páginas
    paginas = num_pagina()

    # Crio a variável desconto
    desconto = float(0)

    # Seleciono a porcentagem de desconto baseada na quantidade de paginas
    ...
    # Retorno o valor da função servico_extra - retorna o valor do serviço extra selecionado
    extra = servico_extra()

    print('\n')

    # Calculo a soma do serviço por página mais o serviço extra.
    soma = ((servico * paginas) + extra)
    print(f'Total: R$ {soma:.2f} (Serviço: R$ {servico:.2f} * {paginas} Páginas + Extra R$ {extra:.2f})')

    # Se houver desconto
    if (desconto > 0):
        # Calculo o valor líquido e exibo ele, o desconto e o valor de desconto
